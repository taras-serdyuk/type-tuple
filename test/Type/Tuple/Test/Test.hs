...
for2 (n, cl, et) (xGen, yGen) = apply2 (zipWithM_ (\x y -> valid (mkInst cl [renderType x, renderType y] (renderType $ et x y)) . truePhantom $ applyClass cl [renderType x, renderType y] (renderType $ et x y))) (applyGen n xGen) (applyGen n yGen)
